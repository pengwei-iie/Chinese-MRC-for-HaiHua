...
def path_config(parser):
    ...
    path_group.add_argument("--train_file", default=None, type=str)
    ...
    path_group.add_argument("--model_type", default="bert", type=str)
...
def run_config(parser):
    ...
    run_group.add_argument("--task_name", default='wic_pair',
                           type=str,
                           required=True)
    run_group.add_argument("--network_name", default='basic',
                           type=str)
    ### Run parameters
    ...
    run_group.add_argument("--from_tf", action='store_true')
    ### Run Mode
