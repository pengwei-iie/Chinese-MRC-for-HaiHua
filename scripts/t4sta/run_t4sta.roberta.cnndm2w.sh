...
GC_STEP=16
GPU_NUM=1
lr_iter=(1 1.5 2) #  (1 0.5 2)
epoch_iter=(4 5 6 7 8 9 10)
SEED=42 # seed_iter=(42 100 512 1024 2019)
WARMUP=50

task_iter=('task4sta')
NET_NAME='basic'
M_NAME='roberta_cnndm2w'

BASE_DIR=/home/xingluxi/IIENLP-SemEval2021/src
DATA_DIR=/data1/data-xlx/semeval21_task4/SemEval2021-Task4
MODEL_PATH=/data1/data-xlx/checkpoints_ft_with_cnndm/lmft_mlm_roberta_max256_gn1_bp8_gc32_lr1_l256_e10_seed42_cgn1/checkpoint-20000
TK_PATH=/data1/data-xlx/checkpoints_ft_with_cnndm/lmft_mlm_roberta_max256_gn1_bp8_gc32_lr1_l256_e10_seed42_cgn1/checkpoint-20000
